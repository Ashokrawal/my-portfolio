...
declare const Texture: React.ForwardRefExoticComponent<Pick<import("@react-three/fiber").ExtendedColors<import("@react-three/fiber").Overwrite<Partial<LAYERS.Texture>, import("@react-three/fiber").NodeProps<LAYERS.Texture, typeof LAYERS.Texture>>>, "attach" | "attachArray" | "attachObject" | "attachFns" | "args" | "children" | "key" | "onUpdate" | keyof LAYERS.Texture> & React.RefAttributes<unknown>>;
